  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.subheader}>Add people you trust. We'll keep them updated during your rides.</Text>
        <Button
        ...
        {trustedContacts.length > 0 && (
          <View style={styles.contactsListSection}>
            <Text style={styles.contactsListTitle}>Your Trusted Contacts</Text>
            <FlatList
